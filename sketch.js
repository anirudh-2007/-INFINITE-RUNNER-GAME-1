...
function setup() {
 ...
 console.log(message)
  ...
  invisibleGround = createSprite(displayWidth/10,displayHeight/2,400,10);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(displayWidth/3,displayHeight/2-20,10,40);
 //  obstacle.velocityX = -(6 + score/100);
   obstacle.velocityX = -(4 + 2* score/50)
